...
void InstancedManager::setupGui(){
    ...
    guiInstanced.add(gMaskRadius.setup("maskRadius", 0.75, 0.0, 1.0));
    guiInstanced.add(gHres.setup("Hres", 0.85, 0., 1.0));
    guiInstanced.add(gVres.setup("Vres", 0.85, 0., 1.0));
    ...
    guiInstanced.add(gNzYAmp.setup("nzYAmp", 0.25, 0.0, 1.0));
